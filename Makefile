...
kernel: bootstrap.o link.ld kernel.o io.o string.o vga.o gdt.o
	i686-elf-ld -m elf_i386 -T link.ld -o kernel.elf bootstrap.o kernel.o io.o string.o vga.o gdt.o
