...
kernel: boot/bootstrap.o boot/gdt.o boot/idt.o link.ld kernel/kernel.o kernel/io.o kernel/mem.o kernel/str.o drivers/vga.o kernel/kprintf.o drivers/serial.o kernel/gdt.o kernel/idt.o
	i686-elf-ld -m elf_i386 -T link.ld -o kernel.bin boot/bootstrap.o boot/gdt.o boot/idt.o kernel/kernel.o kernel/io.o kernel/mem.o kernel/str.o drivers/vga.o kernel/kprintf.o drivers/serial.o kernel/gdt.o kernel/idt.o
